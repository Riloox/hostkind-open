 ...
 * git-ignores config.json, or CI): server.js must materialise config.json
 * from the shipped config.example.json template instead of crashing, and
 * rotate the placeholder jwtSecret before it signs anything.
 *
